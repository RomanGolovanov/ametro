...
//			canvas.drawRect(rect, borderPaint);
    ...
    private void drawText(Canvas canvas, String text, Rect rect, Point align) {
        ...
        if (rect.width() > rect.height()) {
            ...
            if (mTextForegroundPaint != null)
                canvas.drawTextOnPath(text, textPath, -SHADOW_DELTA, -SHADOW_DELTA, mTextForegroundPaint);
            if (mTextBackgroundPaint != null)
                canvas.drawTextOnPath(text, textPath, SHADOW_DELTA, SHADOW_DELTA, mTextBackgroundPaint);
    ...
    private int drawTextOnWhite(Canvas canvas, String text, Rect rect, Point align) {
        ...
        if (align.x > rect.centerX()) { // align to right
            ...
            if (mTextForegroundPaint != null)
                canvas.drawText(text, right - SHADOW_DELTA, top + bounds.height() - SHADOW_DELTA, mTextForegroundPaint);
            if (mTextBackgroundPaint != null)
                canvas.drawText(text, right + SHADOW_DELTA, top + bounds.height() + SHADOW_DELTA, mTextBackgroundPaint);
            ...
            if (mTextForegroundPaint != null)
                canvas.drawText(text, left - SHADOW_DELTA, top + bounds.height() - SHADOW_DELTA, mTextForegroundPaint);
            if (mTextBackgroundPaint != null)
                canvas.drawText(text, left + SHADOW_DELTA, top + bounds.height() + SHADOW_DELTA, mTextBackgroundPaint);
